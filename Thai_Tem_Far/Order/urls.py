...
urlpatterns = [
    ...
    path('admin/manageproduct/product/add/', views.add_edit_product, name='add_edit_product'),
    path('admin/manageproduct/product/<int:id_product>/change/', views.change_product, name='change_product'),
